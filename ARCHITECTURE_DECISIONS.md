...
**Justificación Técnica:** En entornos de mantenimiento crítico aeroespacial o industrial, la matriz de costes es altamente asimétrica. Un Falso Positivo cuesta ~\$2,000 (horas de inspección y pérdida menor de operatividad). Un Falso Negativo (un motor colapsando en pleno vuelo porque el modelo dijo que estaba "Sano") cuesta decenas de millones de dólares por pérdida de hardware, compensaciones y daño irreparable a la reputación de la marca. 
...
**Justificación Técnica:** Desde el punto de vista puramente algorítmico, intentar predecir que a un turbofán le quedan "123.4 vuelos" frente a "125 vuelos" en su ecuador de vida es ruido matemático sin valor de negocio. El desgaste físico de un motor no es lineal al principio de su ciclo. 
...
**Justificación Técnica:** El despliegue Batch clásico sirve para sustituir correas dentadas de coche periódicamente, pero resulta inaceptable si una turbina de 4 millones de dólares manifiesta una vibración anómala en pleno aterrizaje y debemos dictaminar la viabilidad de su despegue a la mañana siguiente.
...
**Justificación Técnica:** El "Feature Importance" nativo (*Gini / Weight*) promedia la capacidad destructiva del árbol pero es mudo: no indica dirección causal (es decir, no te dice si la presión alta rompe el motor o lo cura) y sobre todo, explica el bosque y no el árbol. 
